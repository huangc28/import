...
#import "YCNetConnectDelegate-Protocol.h"
#import "YCNetPingDelegate-Protocol.h"
#import "YCNetTraceRouteDelegate-Protocol.h"
...
- (id)initWithdomain:(id)arg1 port:(int)arg2 Callback:(id)arg3;
